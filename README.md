...
[Play DISSENSO on itch.io](https://edoardocirone.itch.io/dissenso)
...
| Middle mouse button + drag | Drag the camera |
...
- Main Menu: [Furious by FASS](https://uppbeat.io/t/fass/furious), available through Uppbeat
- Gameplay: music from [Three Red Hearts by Abstraction](https://abstractionmusic.bandcamp.com/album/three-red-hearts), released under CC0
