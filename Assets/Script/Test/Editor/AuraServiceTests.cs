...
public class AuraServiceTests
{
    ...
    private static void ConfigureMoraleAura(
        UnitsSO data,
        int auraMorale)
    {
        ...
        serialized.FindProperty("_auraMor").intValue =
            auraMorale;
    ...
    private SpezzoneRuntime CreateSpezzone(
        int q,
        int r,
        SpezzoneSO data,
        int morale = 10)
    ...
    {
        SpezzoneRuntime donor = CreateSpezzone(
            1,
            1,
            _auraSpezzone
        );

        SpezzoneRuntime recipient = CreateSpezzone(
            2,
            1,
            _neutralSpezzone
        );
    ...
    public void Resolve_DoesNotShareAuraAcrossOpposingSides()
    {
        ...
        AuraService.Resolve(
            new List<SpezzoneRuntime> { donor },
            new List<PoliceRuntime> { police },
            _grid
        );
    ...
    {
        SpezzoneRuntime first = CreateSpezzone(
            1,
            1,
            _auraSpezzone,
            morale: 1
        ...
        SpezzoneRuntime middle = CreateSpezzone(
            2,
            1,
            _auraSpezzone,
            morale: 1
        ...
        SpezzoneRuntime tail = CreateSpezzone(
            3,
            1,
            _neutralSpezzone,
            morale: 1
