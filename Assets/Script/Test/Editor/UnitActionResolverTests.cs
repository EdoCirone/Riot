...
public class UnitActionResolverTests
{
    ...
    public void SetUp()
    {
        ...
        _gridObject =
            new GameObject("Unit Action Test Grid");
        ...
        ConfigureUnit(
            _allowedData,
            ActionType.Chant | ActionType.SitStand,
            defence: 2
        );
        ...
        int defence)
    {
        ...
        serialized.FindProperty("_def").intValue =
            defence;
    ...
    private SpezzoneRuntime CreateUnit(
        int q,
        int r,
        SpezzoneSO data,
        int actionPoints = 4)
    ...
    {
        SpezzoneRuntime caster = CreateUnit(
            1,
            1,
            _allowedData
        );

        SpezzoneRuntime adjacent = CreateUnit(
            2,
            1,
            _allowedData
        );

        SpezzoneRuntime distant = CreateUnit(
            4,
            1,
            _allowedData
        );
    ...
    public void ResolveChant_RejectsDisallowedAction()
    {
        ...
        Assert.That(
            result.Failure,
            Is.EqualTo(UnitActionFailure.ActionNotAllowed)
        );
    ...
    {
        SpezzoneRuntime unit = CreateUnit(
            1,
            1,
            _allowedData
        );
